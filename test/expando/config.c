...
static struct ExpandoDefinition TestFormatData[] = {
  // clang-format off
  { "a", "aardvark", 1, 100, E_TYPE_STRING, E_FLAGS_OPTIONAL, NULL },
  { "b", "badger",   1, 101, E_TYPE_STRING, E_FLAGS_OPTIONAL, NULL },
  { "c", "cat",      1, 102, E_TYPE_STRING, E_FLAGS_OPTIONAL, NULL },
...
static struct ConfigDef Vars[] = {
  { "Apple",      DT_EXPANDO,              IP "apple",      IP &TestFormatData, NULL,              }, /* test_initial_values */
  { "Banana",     DT_EXPANDO,              IP "banana",     IP &TestFormatData, NULL,              },
  { "Cherry",     DT_EXPANDO,              IP "cherry",     IP &TestFormatData, NULL,              },
  { "Damson",     DT_EXPANDO,              0,               IP &TestFormatData, NULL,              }, /* test_string_set */
  { "Elderberry", DT_EXPANDO,              IP "elderberry", IP &TestFormatData, NULL,              },
  { "Fig",        DT_EXPANDO|D_NOT_EMPTY,  IP "fig",        IP &TestFormatData, NULL,              },
  { "Guava",      DT_EXPANDO,              0,               IP &TestFormatData, NULL,              }, /* test_string_get */
  { "Hawthorn",   DT_EXPANDO,              IP "hawthorn",   IP &TestFormatData, NULL,              },
  { "Ilama",      DT_EXPANDO,              0,               IP &TestFormatData, NULL,              },
  { "Jackfruit",  DT_EXPANDO,              0,               IP &TestFormatData, NULL,              }, /* test_native_set */
  { "Kumquat",    DT_EXPANDO,              IP "kumquat",    IP &TestFormatData, NULL,              },
  { "Lemon",      DT_EXPANDO|D_NOT_EMPTY,  IP "lemon",      IP &TestFormatData, NULL,              },
  { "Mango",      DT_EXPANDO,              0,               IP &TestFormatData, NULL,              }, /* test_native_get */
  { "Nectarine",  DT_EXPANDO,              IP "nectarine",  IP &TestFormatData, NULL,              }, /* test_reset */
  { "Olive",      DT_EXPANDO,              IP "olive",      IP &TestFormatData, validator_fail,    },
  { "Papaya",     DT_EXPANDO,              IP "papaya",     IP &TestFormatData, validator_succeed, }, /* test_validator */
  { "Quince",     DT_EXPANDO,              IP "quince",     IP &TestFormatData, validator_warn,    },
  { "Raspberry",  DT_EXPANDO,              IP "raspberry",  IP &TestFormatData, validator_fail,    },
  { "Strawberry", DT_EXPANDO,              0,               IP &TestFormatData, NULL,              }, /* test_inherit */
  { "Wolfberry",  DT_EXPANDO|D_ON_STARTUP, IP "wolfberry",  IP &TestFormatData, NULL,              }, /* startup */
  { NULL },
};
// clang-format on
...
static bool test_native_set(struct ConfigSubset *sub, struct Buffer *err)
{
  ...
  {
    buf_reset(err);
    struct Expando *exp = expando_parse(valid[i], TestFormatData, NULL);
  ...
  name = "Wolfberry";
  struct Expando *exp = expando_parse("wolfberry", TestFormatData, NULL);
  rc = cs_str_native_set(cs, name, (intptr_t) exp, err);
  expando_free(&exp);
  TEST_CHECK(CSR_RESULT(rc) == CSR_SUCCESS);

  exp = expando_parse("apple", TestFormatData, NULL);
  rc = cs_str_native_set(cs, name, (intptr_t) exp, err);
  expando_free(&exp);
  TEST_CHECK(CSR_RESULT(rc) != CSR_SUCCESS);
...
static bool test_reset(struct ConfigSubset *sub, struct Buffer *err)
{
  ...
  struct Expando *exp = expando_parse("apple", TestFormatData, NULL);
  rc = cs_str_native_set(cs, name, (intptr_t) exp, err);
  expando_free(&exp);
  TEST_CHECK(CSR_RESULT(rc) == CSR_SUCCESS);
...
static bool test_validator(struct ConfigSubset *sub, struct Buffer *err)
{
  ...
  buf_reset(err);
  struct Expando *exp = expando_parse("world", TestFormatData, NULL);
  rc = cs_str_native_set(cs, name, (intptr_t) exp, err);
  expando_free(&exp);
  if (TEST_CHECK(CSR_RESULT(rc) == CSR_SUCCESS))
  {
  ...
  buf_reset(err);
  exp = expando_parse("world", TestFormatData, NULL);
  rc = cs_str_native_set(cs, name, (intptr_t) exp, err);
  expando_free(&exp);
  if (TEST_CHECK(CSR_RESULT(rc) == CSR_SUCCESS))
  {

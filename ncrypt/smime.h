...
{
  ED_SMI_ALGORITHM = 1,        ///< XXX
  ED_SMI_CERTIFICATE_IDS,      ///< XXX
  ED_SMI_DIGEST_ALGORITHM,     ///< XXX
  ED_SMI_INTERMEDIATE_IDS,     ///< XXX
  ED_SMI_KEY,                  ///< XXX
  ED_SMI_MESSAGE_FILE,         ///< XXX
  ED_SMI_SIGNATURE_FILE,       ///< XXX
};

...
/**
 * NntpFormatData - Expando definitions
 *
 * Config:
 * - $inews
 * - $newsrc
...
const struct ExpandoDefinition NntpFormatData[] = {
  ...
  { "P", "port-if",  ED_NNTP, ED_NTP_PORT_IF,  E_TYPE_NUMBER, E_FLAGS_NO_FLAGS, NULL },
  { "S", "schema",   ED_NNTP, ED_NTP_SCHEMA,   E_TYPE_STRING, E_FLAGS_NO_FLAGS, NULL },
  { "s", "server",   ED_NNTP, ED_NTP_SERVER,   E_TYPE_STRING, E_FLAGS_NO_FLAGS, NULL },
  { "u", "username", ED_NNTP, ED_NTP_USERNAME, E_TYPE_STRING, E_FLAGS_NO_FLAGS, NULL },
...
static struct ConfigDef NntpVars[] = {
  ...
  { "newsrc", DT_EXPANDO|D_PATH_FILE, IP "~/.newsrc", IP &NntpFormatData, NULL,
